...
build_model(
    weight_uri='./hpaseg-model/nuclei_model.pt',
    test_inputs=['./hpaseg-model/test_nuclei_input.npy'],
    test_outputs=['./hpaseg-model/test_nuclei_output.npy'],
    input_axes=["bcyx"],
    output_axes=["bcyx"],
    output_path='./nuc_model.zip',
    name="HPA Nucleus Segmentation (DPNUnet)",
    description="Nucleus segmentation model for segmenting images from the Human Protein Atlas",
